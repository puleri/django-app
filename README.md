...
This template contains a project, `django_app`, and an app, `api`,
...
1. Replace all instances of `django_app` with your application name. **This includes the folder included in this repository.**
...
This template includes a project `django_app` which should be renamed
...
all instances of `django_app` with your app's name.
